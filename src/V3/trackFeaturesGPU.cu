...
void KLTTrackFeatures(
    ...
    cudaMemcpy(d_pyramid1_img, h_pyramid1_img_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
    cudaMemcpy(d_pyramid1_gradx, h_pyramid1_gradx_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
    cudaMemcpy(d_pyramid1_grady, h_pyramid1_grady_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
    cudaMemcpy(d_pyramid2_img, h_pyramid2_img_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
    cudaMemcpy(d_pyramid2_gradx, h_pyramid2_gradx_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
    cudaMemcpy(d_pyramid2_grady, h_pyramid2_grady_ptrs, tc->nPyramidLevels * sizeof(float*), cudaMemcpyHostToDevice);
